    ...
    <div className="flex flex-col gap-0 pb-20 overflow-hidden w-full">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 h-auto md:h-[500px]">
          {[
            { name: "iPhone", img: "https://picsum.photos/seed/catiphone/400/600", col: "col-span-2 md:col-span-2 row-span-2 md:row-span-1", bg: "from-slate-950/90" },
            ...
            { name: "iPad", img: "https://picsum.photos/seed/catipad/400/400", col: "col-span-1 md:col-span-1 md:row-span-1", bg: "from-slate-950/80" },
          ].map((cat, idx) => (
            <Link 
              key={cat.name} 
