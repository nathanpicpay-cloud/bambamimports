  ...
  if (submitted) {
     return (
       <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-6 animate-fade-in-up">
         ...
         <h2 className="text-4xl font-black text-white mb-4">Agendamento Recebido!</h2>
    ...
    <div className="min-h-screen py-12 md:py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          {/* Service List */}
          <div className="lg:col-span-7 space-y-8 animate-fade-in-up animate-delay-100">
            <h3 className="text-2xl font-bold text-white">Escolha o Reparo</h3>
            <div className="grid sm:grid-cols-2 gap-5">
              {SERVICES.map((service) => (
                ...
                >
                  ...
                  <p className="text-sm text-slate-400 mb-6 h-10 leading-relaxed">{service.description}</p>
          ...
          <div className="lg:col-span-5 animate-fade-in-up animate-delay-200 sticky top-32">
            <div className="bg-slate-900/80 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/5 shadow-2xl shadow-black/20">
